              ...
              ConstrainedBox(
                ...
                child: Card(
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      children: [
                        Image.asset('assets/imagens/LOGO_UNICV_COLORIDA.png', width: 300, height: 150,),
                        const SizedBox(height: 25),
                        const CampoDeTexto(label: 'Usuário',),
                        const SizedBox(height: 25),
                        const CampoDeTexto(label: 'Senha',),
                        const SizedBox(height: 25,),
                        Row(
                          mainAxisAlignment: MainAxisAlignment.center,
                          children: [
